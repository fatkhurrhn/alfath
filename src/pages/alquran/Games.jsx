                        ...
                        {gamesWithModes.map((game) => {
                            ...
                            return (
                                ...
                                >
                                        ...
                                        >
                                            <div>
                                                ...
                                                >
                                                    ...
                                                    <i
                                                        className={`ri-arrow-down-s-line text-gray-500 transition-transform ${expanded === game.id ? "rotate-180" : ""
                                                            }`}
                                                    ></i>
                                                </div>
                                            </div>
                                    ...
                                    {/* Content */}
                                    <div
                                        className={`transition-all duration-300 ${expanded === game.id ? "max-h-[800px] opacity-100" : "max-h-0 opacity-0"
                                            } overflow-hidden`}
                                    >
