...
export default function Juz4() {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const res = await fetch('https://api.myquran.com/v2/quran/ayat/juz/4');
  ...
  const gameRecord = {
    ...
    // PENTING
    juz: "Juz 4",          // ⬅️ nomor juz
    juzNumber: 4, // ⬅️ penting untuk link ulangi
  };
