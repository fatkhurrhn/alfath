...
export default function Juz3() {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const res = await fetch('https://api.myquran.com/v2/quran/ayat/juz/3');
  ...
  const gameRecord = {
    ...
    // PENTING
    juz: "Juz 3",          // ⬅️ nomor juz
    juzNumber: 3, // ⬅️ penting untuk link ulangi
  };
