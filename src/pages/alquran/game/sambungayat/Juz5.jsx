...
export default function Juz5() {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const res = await fetch('https://api.myquran.com/v2/quran/ayat/juz/5');
  ...
  const gameRecord = {
    ...
    // PENTING
    juz: "Juz 5",          // ⬅️ nomor juz
    juzNumber: 5, // ⬅️ penting untuk link ulangi
  };
