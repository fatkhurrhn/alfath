...
export default function Juz25() {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const res = await fetch('https://api.myquran.com/v2/quran/ayat/juz/25');
  ...
  const gameRecord = {
    ...
    // PENTING
    juz: "Juz 25",          // ⬅️ nomor juz
    juzNumber: 25, // ⬅️ penting untuk link ulangi
  };
