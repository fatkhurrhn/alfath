...
export default function Juz26() {
  ...
  const fetchQuestions = async () => {
    try {
      ...
      const res = await fetch('https://api.myquran.com/v2/quran/ayat/juz/26');
  ...
  const gameRecord = {
    ...
    // PENTING
    juz: "Juz 26",          // ⬅️ nomor juz
    juzNumber: 26, // ⬅️ penting untuk link ulangi
  };
